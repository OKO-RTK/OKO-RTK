        ...
        <Card>
          ...
          <CardContent className="space-y-2">
            <div className="space-y-1">
              <Input id="name" placeholder="Телефон или почта" className="placeholder:opacity-60"/>
            </div>
            <div className="space-y-1">
              <Input id="password" placeholder="Пароль" className="placeholder:opacity-60"/>
            </div>
          </CardContent>
          <CardFooter>
            <Button>Войти</Button>
            <TabsList className="grid w-full grid-cols-1">
               <TabsTrigger value="inter-password">Войти с помощью кода</TabsTrigger>
            </TabsList>
       ...
       <TabsContent value="inter-password">
        <Card>
          <CardHeader>
            ...
            <CardDescription>
              Укажите номер телефона, email или логин, и мы вышлем вам код подтвержения
            </CardDescription>
          </CardHeader>
          <CardContent className="space-y-2">
            <div className="space-y-1">
